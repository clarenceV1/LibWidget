...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.slidingTabTextColor = t.getColor(R.styleable.SlidingTabLayout_slidingTabTextColor, slidingTabTextColor);
        this.slidingTabTextSelectColor = t.getColor(R.styleable.SlidingTabLayout_slidingTabTextSelectColor, slidingTabTextSelectColor);
        ...
        this.slidingTabIndicatorColor = t.getColor(R.styleable.SlidingTabLayout_slidingTabIndicatorColor, slidingTabIndicatorColor);
...
//        textView.setTypeface(Typeface.DEFAULT_BOLD);
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            ((TextView) tabView).setTextSize(slidingTabTextSize);
            ...
            if (positionOffset == 0) {
                try {
                    ...
                    if (mCurrentPosition >= 0 && mCurrentPosition != tabIndex) {
                        ((TextView) mTabStrip.getChildAt(mCurrentPosition)).setTextColor(slidingTabTextColor);
                    }
